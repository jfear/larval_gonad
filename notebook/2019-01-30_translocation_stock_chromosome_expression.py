...
# %% [markdown]
# # Translocation STock Chromosome Expression
...
# %%
# Setup notebook
nbconfig = Nb.setup_notebook(seurat_dir='../output/translocations-wf/translocation_stock_force')
...
g.fig.suptitle('Translocation Stock', fontsize=10);
