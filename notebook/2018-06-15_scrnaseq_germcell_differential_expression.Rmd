...
fname <- '2018-06-15_scrnaseq_spermatogonia_vs_early_biomarkers.tsv'
...
fname <- '2018-06-15_scrnaseq_spermatogonia_vs_mid_biomarkers.tsv'
markers$gene = rownames(markers)
markers = merge(fbgn2symbol, markers, by.x='primary_FBgn', by.y='gene', all.y=T)
save_biomarkers(markers = markers, dir = OUTDIR, fname = fname)
```
...
fname <- '2018-06-15_scrnaseq_spermatogonia_vs_late_biomarkers.tsv'
markers$gene = rownames(markers)
markers = merge(fbgn2symbol, markers, by.x='primary_FBgn', by.y='gene', all.y=T)
save_biomarkers(markers = markers, dir = OUTDIR, fname = fname)
```
