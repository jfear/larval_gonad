...
# %% [markdown]
# First look at BM21 sample. Just trying to see what cluster is what.
...
# %%
nb = Nb.setup_notebook(seurat_dir='../output/translocations-wf/translocation_BM21_force')
...
plt.title('Testis BM21 Literature Genes');
