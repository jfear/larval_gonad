...
# %%
def plot(fname='../output/notebook/2019-02-20_tsne.svg', force=False):
...
# %%
def plot(fname='../output/notebook/2019-02-20_lit_genes.svg' , force=False):
    if Path(fname).exists() and not force:
        display(SVG(fname))
        return 
...
# %%
def plot(fname='../output/notebook/2019-02-20_all_lit_genes.svg', force=False):
    if Path(fname).exists() and not force:
        display(SVG(fname))
        return 
...
# %%
def plot(fname='../output/notebook/2019-02-20_unique_biomakrer_genes.svg', force=False):
    if Path(fname).exists() and not force:
        display(SVG(fname))
        return 
...
# %%
def plot(fname='../output/notebook/2019-02-20_multi_biomakrer_genes.svg', force=False):
    if Path(fname).exists() and not force:
        display(SVG(fname))
        return 
...
# %%
def plot(fname='../output/notebook/2019-02-20_bar_plot_tpm_expression_by_arm.svg', force=False):
    if Path(fname).exists() and not force:
        display(SVG(fname))
        return 
...
# %%
def plot(fname='../output/notebook/2019-02-20_bar_plot_log2_tpm_expression_by_arm.svg', force=False):
    if Path(fname).exists() and not force:
        display(SVG(fname))
        return 
    tpm = (
...
# %%
def plot(fname='../output/notebook/2019-02-20_bar_plot_percent_expressed_by_arm.svg', force=False):
    if Path(fname).exists() and not force:
        display(SVG(fname))
        return 
    raw = (
