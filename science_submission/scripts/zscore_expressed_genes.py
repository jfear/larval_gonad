"""Save zscores for all expressed genes.

Save a version of the zscore table with the all expressed genes pulled out.

1. Get list of expressed FBgns and gene_symbols
2. Get zscores and pull out expressed genes.
...
if __name__ == "__main__":
    ...
    #     fbgns="../../output/cellselection-wf/expressed_genes.pkl",
    #     output_file="",
    # )
