""" Proportion of reads mapping scaled by number of genes per chromosome

This is a set of 4 panels. Each panel has:

- x-axis: Chromosome Arm
- y-axis: proportion reads mapping to chrom / total counts per sample / number genes per arm / 1e3
