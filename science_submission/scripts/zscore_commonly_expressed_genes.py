"""Save zscores for commonly expressed genes.

Save a version of the zscore table with the commonly expressed genes pulled out.

1. Get list of commonly expressed FBgns and gene_symbols
2. Get zscores and pull out commonly expressed genes.
...
if __name__ == "__main__":
    ...
    #     fbgns="../../output/cellselection-wf/commonly_expressed_genes.pkl",
    #     output_file="",
    # )
