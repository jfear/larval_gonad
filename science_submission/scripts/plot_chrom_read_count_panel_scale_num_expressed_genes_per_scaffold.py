""" Proportion of reads mapping scaled by number of expressed genes per chromosome
...
- y-axis: proportion reads mapping to chrom / total counts per sample / number expressed genes per arm / 1e3
