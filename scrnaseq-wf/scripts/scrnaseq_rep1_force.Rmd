---
title: Run Seurat on Testis Rep 1
author: Justin Fear
...
OUTDIR <- '../../output/scrnaseq-wf/scrnaseq_rep1_force'
...
rep <- 'rep1'
data.dir <- '../../output/scrnaseq-wf/scrnaseq_samples/testis1_force/outs/filtered_gene_bc_matrices/dm6.16'
```
