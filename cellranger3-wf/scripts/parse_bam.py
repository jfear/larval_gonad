...
def main():
    ...
    chrom_counts_by_cell.extend(fetch_reads_from_chromosome(sam_file_handler, 'chr2L'))
    chrom_counts_by_cell.extend(fetch_reads_from_chromosome(sam_file_handler, 'chr2R'))
    chrom_counts_by_cell.extend(fetch_reads_from_chromosome(sam_file_handler, 'chr3L'))
    chrom_counts_by_cell.extend(fetch_reads_from_chromosome(sam_file_handler, 'chr3R'))
    chrom_counts_by_cell.extend(fetch_reads_from_chromosome(sam_file_handler, 'chr4'))
    chrom_counts_by_cell.extend(fetch_reads_from_chromosome(sam_file_handler, 'chrX'))
    chrom_counts_by_cell.extend(fetch_reads_from_chromosome(sam_file_handler, 'chrY'))
