"""D. mel housekeeping genes based on TSPS.
...
if __name__ == "__main__":
    if os.getenv("SNAKE_DEBUG", False):
        ...
        snakemake = snakemake_debug(
            ...
            input=dict(
                male=[
                    "../output/expression-atlas-wf/tsps_housekeeping/w1118_male.pkl",
                    "../output/expression-atlas-wf/tsps_housekeeping/orgR_male.pkl",
                ],
                female=[
                    "../output/expression-atlas-wf/tsps_housekeeping/w1118_female.pkl",
                    "../output/expression-atlas-wf/tsps_housekeeping/orgR_female.pkl",
                ],
