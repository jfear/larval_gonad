...
OUTDIR <- '../../output/translocations-wf/translocation_BM21_force'
...
rep <- 'rep1'
data.dir <- '../../output/translocations-wf/scrnaseq_samples/testis_BM21_force/outs/filtered_gene_bc_matrices/dm6.16'
```
