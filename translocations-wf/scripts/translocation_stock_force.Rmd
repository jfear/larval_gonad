---
title: Run Seurat on Testis Translocation BM5
author: Justin Fear
...
OUTDIR <- '../../output/translocations-wf/translocation_stock_force'
...
rep <- 'rep1'
data.dir <- '../../output/translocations-wf/scrnaseq_samples/testis_stock_force/outs/filtered_gene_bc_matrices/dm6.16'
```
...
```{r run_tsne}
sobj <- RunTSNE(sobj, reduction.use = "pca", dims.use = 1:6, do.fast = TRUE)

p1 <- TSNEPlot(sobj, do.return = T, pt.size = 0.5)
