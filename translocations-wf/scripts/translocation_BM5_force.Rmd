...
OUTDIR <- '../../output/translocations-wf/translocation_BM5_force'
...
rep <- 'rep1'
data.dir <- '../../output/translocations-wf/scrnaseq_samples/testis_BM5_force/outs/filtered_gene_bc_matrices/dm6.16'
```
