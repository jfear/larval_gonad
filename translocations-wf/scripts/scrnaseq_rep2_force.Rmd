...
OUTDIR <- '../../output/translocations-wf/scrnaseq_rep2_force'
...
rep <- 'rep2'
data.dir <- '../../output/translocations-wf/scrnaseq_samples/testis2_force/outs/filtered_gene_bc_matrices/dm6.16'
```
