...
tesits1 <- load.data('./', 'testis1')
tesits2 <- load.data('./', 'testis2')
tesits3 <- load.data('./', 'testis3')
```

## Find Shared Highly Variable Genes Among Replicates
```{r find_variable_genes}
# TODO convert to a loop over the list
...
#TODO make the variable gene numbers as part of the document.
```
