...
## Early Primary Spermatocytes (P1)
...
gl <- c(lit_genes[["SP_ES"]], lit_genes[["ES"]])
print(sum(gl %in% res@gene) / length(gl))
```

## Primary Spermatocytes 

### Biolgoical Process (P2)
...
gl <- c(lit_genes[["PS"]], lit_genes[["LS"]])
print(sum(gl %in% res@gene) / length(gl))
```

### Biolgoical Process (P3)
...
gl <- c(lit_genes[["EC"]], lit_genes[["CY"]])
print(sum(gl %in% res@gene) / length(gl))
```
