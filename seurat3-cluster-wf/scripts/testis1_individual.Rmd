...
DATA_DIR <- file.path(PROJ_DIR, 'output/cellselection-wf/testis1')
...
```{r save_biomarkers}
write.table(biomarkers, file = file.path(OUTDIR, "biomarkers.tsv"), sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)
```
